<!DOCTYPE html>
	...
	$result = mysqli_connect($host,$user) or die("Could not connect to database." .mysqli_error());
	mysqli_select_db($result,$dbname) or die("Could not select the databse." .mysqli_error());
	$image_query = mysqli_query($result,"select image,name from student");
	...
	<div class="img-block">
	<img src="<?php echo $img_src; ?>" alt="" title="<?php echo $image; ?>" class="img-responsive" />
